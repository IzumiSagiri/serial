...
int WINAPI WinMainSettings(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd)
{
    ...
    wcSettings.hbrBackground=(HBRUSH)GetStockObject(BLACK_BRUSH);
    ...
    hwndSettings=CreateWindowA("testSettings","SettingsWindow",WS_VISIBLE | WS_SYSMENU | WS_CAPTION | WS_MINIMIZEBOX,0,0,WIDTH,HEIGHT,NULL,NULL,hinstSettings,NULL);
    hwndSettings_button=CreateWindowA("button","Confirm",WS_VISIBLE | WS_CHILD | BS_PUSHBUTTON,50,50,100,100,hwndSettings,(HMENU)BUTTON_ID,hInstance,NULL);
    hwndSettings_listbox=CreateWindowA("listbox", NULL,WS_VISIBLE | WS_CHILD | LBS_SORT | LBS_NOTIFY | WS_VSCROLL, 20,20,220,220,hwndSettings,(HMENU)LIST_ID,hInstance,NULL);
    hwndSettings_listbox2=CreateWindowA("listbox", NULL,WS_VISIBLE | WS_CHILD | LBS_SORT | LBS_NOTIFY | WS_VSCROLL, 300,20,500,220,hwndSettings,(HMENU)LIST_ID2,hInstance,NULL);
    hwndSettings_listbox3=CreateWindowA("listbox", NULL,WS_VISIBLE | WS_CHILD | LBS_SORT | LBS_NOTIFY | WS_VSCROLL, 20,300,220,500,hwndSettings,(HMENU)LIST_ID3,hInstance,NULL);
    hwndSettings_listbox4=CreateWindowA("listbox", NULL,WS_VISIBLE | WS_CHILD | LBS_SORT | LBS_NOTIFY | WS_VSCROLL, 300,300,500,500,hwndSettings,(HMENU)LIST_ID4,hInstance,NULL);
